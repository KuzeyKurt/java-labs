...
public class Logic 
    ...
    static  double rightTriangleArea (double length, double width)
    {
    ...
    static  double rightTrianglePerimeter (double base, double height)
    {
        ...
        double tPerimeter = base+height+hypo;
        return  tPerimeter;
    ...
    {
        double surfaceArea = (length*width*2) + (width*depth*2) + (depth*length*2);
        return  surfaceArea;
    }
